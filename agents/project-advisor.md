...
2. Search the repository to locate specific files, classes, and functions
3. Return: file path, line range, brief explanation of purpose

### For "what should I try" questions (research direction)
0. Read `docs/TODO.md` (if it exists) — check P0 blocking items and P1 high-priority tasks first
...
4. Read the `docs/TODO.md` P0 section for current blockers (if the file exists)
...
If SKILL.md is outdated or empty, suggest using LabMate's
`update-project-skill` skill to refresh project knowledge.
