---
name: read-paper
description: Use when the user explicitly requests a deep read of one paper or technical report, or invokes read-paper on a literature hub that needs candidate triage. Triggers on /read-paper, 精读论文, 读这篇 paper, deep-dive this paper.
